...
//7 syscall numbers
#define WIN_NT_ALLOCATE_VIRTUAL_MEMORY 0x13
#define WIN_NT_CREATE_PROCESS_EX 0x50
#define WIN_NT_CREATE_SECTION 0x54
#define WIN_NT_CREATE_THREAD 0x57
#define WIN_NT_CREATE_THREAD_EX 0x58	
#define WIN_NT_DELETE_FILE 0x66
#define WIN_NT_FREE_VIRTUAL_MEMORY 0x83
#define WIN_NT_MAP_VIEW_OF_SECTION 0xa8
#define WIN_NT_PROTECT_VIRTUAL_MEMORY 0xd7
#define WIN_NT_QUERY_VIRTUAL_MEMORY 0x10b
#define WIN_NT_SET_INFORMATION_THREAD 0x14f
#define WIN_NT_SUSPEND_THREAD 0x16f
#define WIN_NT_TERMINATE_PROCESS 0x172
#define WIN_NT_TERMINATE_THREAD 0x173
#define WIN_NT_WRITE_VIRTUAL_MEMORY 0x18f
#define WIN_NT_CREATE_USER_PROCESS 0x5d

#define CONVENTION NTAPI
#define KI_SERVICE_LIMIT 0x191
...
{
/*0x000*/     ULONG64      Valid : 1;         // 0 BitPosition
/*0x000*/     ULONG64      PageFileLow : 4;   // 1 BitPosition
/*0x000*/     ULONG64      Protection : 5;    // 5 BitPosition
/*0x000*/     ULONG64      Prototype : 1;     // 10 BitPosition
/*0x000*/     ULONG64      Transition : 1;    // 11 BitPosition
/*0x000*/     ULONG64      PageFileHigh : 52; // 12 BitPosition
...
//NTSTATUS ZwSuspendProcess(HANDLE);	
...
typedef PEPROCESS (NTAPI *proto_PsGetNextProcess)(PEPROCESS);
typedef NTSTATUS (NTAPI *proto_PsSuspendProcess)(PEPROCESS);
typedef NTSTATUS (NTAPI *proto_PsTerminateProcess)(PEPROCESS);
typedef NTSTATUS (NTAPI *proto_PsResumeProcess)(PEPROCESS);

//Hooked functions prototypes
typedef NTSTATUS (NTAPI *proto_NtCreateUserProcess)(PHANDLE, PHANDLE, ACCESS_MASK, ACCESS_MASK, POBJECT_ATTRIBUTES, POBJECT_ATTRIBUTES, ULONG, ULONG , PVOID , PVOID , PVOID);
...
typedef NTSTATUS (NTAPI *proto_NtMapViewOfSection)(HANDLE, HANDLE , PVOID *, ULONG , SIZE_T , PLARGE_INTEGER , PSIZE_T ,SECTION_INHERIT , ULONG , ULONG );
...
typedef NTSTATUS (NTAPI * proto_NtSuspendProcess)(HANDLE);
typedef NTSTATUS (NTAPI * proto_NtGetNextProcess)(HANDLE, ULONG, ULONG, ULONG, PHANDLE);
...
/*
typedef VOID (NTAPI * proto_PsSetCreateProcessNotifyRoutineEx)(PVOID, DWORD);
typedef VOID (NTAPI * proto_PsSetCreateThreadNotifyRoutine)(PVOID, DWORD);
typedef VOID (NTAPI * proto_PsSetLoadImageNotifyRoutine)(PVOID, DWORD);
*/
